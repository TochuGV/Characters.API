...
import { jwtStrategy } from "./configuration/jwt.strategy.js";
import swaggerConfiguration from "./configuration/swagger.configuration.js";
...
const app = express();
app.use("/api-docs", swaggerUi.serve, swaggerUi.setup(swaggerDocument, swaggerConfiguration));
app.use(helmet());
